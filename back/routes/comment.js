...
router.put("/update/:id",auth , setComment, accessComment, commentController.update);
router.delete("/delete/:id",auth , setComment, accessComment, commentController.delete)
